...
- Open questions: None.
- Implementation progress: Implemented through committed plan tasks; signing, publishing, CI, and verifier surfaces are configured but not executed for a public release.
