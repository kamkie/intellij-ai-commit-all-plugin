...
- `PLAN-execution-context-discipline` - Execution Context Discipline ([PLAN-execution-context-discipline.md](PLAN-execution-context-discipline.md)), draft companion plan for proposed `adr-0075`.
