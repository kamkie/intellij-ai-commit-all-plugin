...
- `PLAN-transitive-build-dependency-remediation` - Transitive Build Dependency Remediation ([PLAN-transitive-build-dependency-remediation.md](PLAN-transitive-build-dependency-remediation.md)), blocked at deterministic release-matrix UI validation.
