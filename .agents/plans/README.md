...
- `PLAN-intellij-patch-upgrade-automation` - IntelliJ Patch Upgrade Automation ([PLAN-intellij-patch-upgrade-automation.md](PLAN-intellij-patch-upgrade-automation.md)), approved and in progress.
