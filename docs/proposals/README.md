...
|--------------------------------------------------------------------------------------------------|---------|----------------------------------------------------------|----------|---------|---------------------------------------------------------------------------------------------------|
| [PROP-02-pre-release-ux](PROP-02-pre-release-ux-2026-05-15T09-57.md)                             | E006    | Evaluate shortcut takeover with opt-out                  | 3        | blocked | Proposed [ADR 0054](../decisions/ard-0054-use-vcs-shortcuts-for-ai-commit-all-with-opt-out.md); implementation waits for maintainer acceptance. |
