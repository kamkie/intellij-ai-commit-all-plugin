...
|--------------------------------------------------------------------------------------------------|---------|----------------------------------------------------------|----------|---------|---------------------------------------------------------------------------------------------------|
| [PROP-02-pre-release-ux](PROP-02-pre-release-ux-2026-05-15T09-57.md)                             | E006    | Evaluate shortcut takeover with opt-out                  | 3        | open    | Accepted [ADR 0054](../decisions/ard-0054-use-vcs-shortcuts-for-ai-commit-all-with-opt-out.md); implementation has not started. |
...
| [PROP-03-repository-quality-lifecycle](PROP-03-repository-quality-lifecycle-2026-05-15T09-57.md) | E004    | Validate Gradle wrapper integrity in CI                  | 2        | open    | Open intake; no task or plan selected.                                                            |
