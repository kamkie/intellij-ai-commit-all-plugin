...
|--------------------------------------------------------------------------------------------------|---------|--------------------------------------------------------------------|----------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| [PROP-maintainability-stability-audit](PROP-maintainability-stability-audit-2026-05-24T20-17.md) | F002    | Extend deterministic release-matrix UI automation beyond IDEA      | 5        | planned      | Approved plan [PLAN-maintainability-stability-audit](../../.agents/plans/PLAN-maintainability-stability-audit.md) covers implementation after predecessor tasks complete. |
| [PROP-maintainability-stability-audit](PROP-maintainability-stability-audit-2026-05-24T20-17.md) | E001    | Pull-request CI does not run the full documentation validator      | 2        | planned      | Approved plan [PLAN-maintainability-stability-audit](../../.agents/plans/PLAN-maintainability-stability-audit.md) covers implementation after `T1-push-completion-results`. |
| [PROP-maintainability-stability-audit](PROP-maintainability-stability-audit-2026-05-24T20-17.md) | E003    | Compatibility-boundary failures are often silent                   | 4        | planned      | Approved plan [PLAN-maintainability-stability-audit](../../.agents/plans/PLAN-maintainability-stability-audit.md) covers implementation after predecessor tasks complete. |
| [PROP-maintainability-stability-audit](PROP-maintainability-stability-audit-2026-05-24T20-17.md) | S001    | Split the three-section Swing control into reviewable units        | 6        | planned      | Approved plan [PLAN-maintainability-stability-audit](../../.agents/plans/PLAN-maintainability-stability-audit.md) covers implementation after the cross-product UI smoke task. |
