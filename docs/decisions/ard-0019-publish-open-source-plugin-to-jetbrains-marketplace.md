...
* Adopt Publish Open-Source Plugin To JetBrains Marketplace
...
Chosen option: "Adopt Publish Open-Source Plugin To JetBrains Marketplace", because Official JetBrains Marketplace publication is in scope for this project.
...
* Good, because Official JetBrains Marketplace publication is in scope for this project.
...
* Bad, because the user plans official Marketplace publication.

### Publish only a local ZIP artifact.

* Bad, because the target distribution channel is the official JetBrains Marketplace.

### Add paid-plugin licensing checks.

* Bad, because the project direction is open-source Marketplace publication, not a paid plugin.
